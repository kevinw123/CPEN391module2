...
void createInsertCommand(char *id, char *start_lat, char *start_long, char *end_lat, char *end_long, char *start_time, char *end_time, char *total_distance, char *speed, char *ret);
void createCallCommand(char *numberToCall, char *ret);
void waitForAPIResponse(int size, char *ret);
